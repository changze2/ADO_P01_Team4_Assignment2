...
def fetch_api_data(**kwargs):
    ...
    try:
        ...
        for key in meeting_keys:
            api_url = f"https://api.openf1.org/v1/position?session_key={key}"
...
def load_to_snowflake(**kwargs):
    ...
    # Example usage
    insert_query = generate_insert_query('LAPS_API', schema_dict)
    print(insert_query)
